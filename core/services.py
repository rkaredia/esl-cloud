    ...
    try:
        ...
        if commit:
            with transaction.atomic():
                ...
                if updated_skus:
                    # PERFORMANCE: Evaluate the queryset into a list to prevent lazy-loading issues
                    # within the transaction.on_commit hook.
                    ...
                    # This reduces Redis round-trips and Celery overhead from O(N) to O(1).
                    if tag_ids:
