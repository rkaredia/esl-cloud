        ...
        if commit:
            with transaction.atomic():
                ...
                if updated_skus:
                    ...
                    # PERFORMANCE: Evaluate QuerySet into a list immediately to avoid lazy-loading
                    # queries being triggered inside the on_commit hook.
                    ...
                    # PERFORMANCE: Use trigger_bulk_sync (O(1) Redis round-trips) instead of O(N) loop.
                    if tag_ids:
