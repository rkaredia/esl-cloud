...
def generate_esl_image(tag_id, tag_instance=None):
    ...
    try:
        ...
        # 3. Final alignment and conversion
        # Match hardware requirements: convert to RGBA for final output.
        # Redundant resize((width, height), LANCZOS) removed as image is already at target dimensions.
